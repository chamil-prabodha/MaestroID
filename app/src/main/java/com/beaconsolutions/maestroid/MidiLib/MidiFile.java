package com.beaconsolutions.maestroid.MidiLib;
...
import java.util.*;
/**
 * Created by Chamil Prabodha on 20/06/2015.
 */
public class MidiFile {
    ...
    public void writeToFile(String filename,Context ctx)
        ...
        File filepath = new File(Environment.getExternalStorageDirectory().getAbsolutePath().toString()+"/Android/data/com.beaconsolutions.maestroid/files/");
        filepath.mkdirs();
